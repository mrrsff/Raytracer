...
namespace Raytracer.Rendering.CPU.Intersections;

public static class TriangleIntersection
{
    public static bool Intersect(this TriangleData triangle, in Ray ray, in VertexData vertexData,
    ...
    public static bool Intersect(in Ray ray, in Vector3 v0, in Vector3 v1, in Vector3 v2, in Vector3 normal,
        ref IntersectionInfo info)
    {
